...
<div class="max-w-2xl mx-auto">
    <div class="mb-8 flex items-center justify-between">
        <div>
            <div class="flex items-center gap-2 text-sm text-brand-400 mb-2">
                ...
                <span class="text-slate-300">Nuevo Grupo</span>
            </div>
            <h1 class="text-3xl font-bold tracking-tight text-white">Configurar Grupo Extra</h1>
            <p class="mt-1 text-sm text-slate-400">Crea un grupo o división adicional para los equipos de esta liga.</p>
        </div>
    ...
    <div class="bg-dark-card rounded-xl border border-dark-border shadow-sm overflow-hidden p-6">
        <form method="POST" action="{{ route('admin.groups.store', $league) }}" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" class="block w-full rounded-lg border-0 py-2.5 pl-10 bg-dark-bg text-white ring-1 ring-inset ring-dark-border focus:ring-2 focus:ring-inset focus:ring-brand-500 sm:text-sm sm:leading-6" placeholder="Ej. Grupo de la Muerte, División Este..." required>
                </div>
            </div>
